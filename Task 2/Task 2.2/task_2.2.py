...
class Simulator:
    ...
    # def write_to_csv(self, filepath=r'C:\Users\nayan\Documents\IoT Analytics\Projects\Task_2.2_Output.csv'):
    def write_to_csv(self, filepath='Task_2.2_Output.csv'):
        self.df = pd.DataFrame(self.data, columns=self.columns)
...
simulator = Simulator(rt_arrival_time, non_rt_arrival_time, rt_service_time, non_rt_service_time, 200)
